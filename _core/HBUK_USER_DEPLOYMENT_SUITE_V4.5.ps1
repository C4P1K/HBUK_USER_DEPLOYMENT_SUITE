...
# Tema gelap moden: gaya GitHub Dark / VS Code
$script:IsDarkMode = $false
function Set-UITheme {
    if ($script:IsDarkMode) {
        # -- DARK MODE -- (GitHub Dark palette)
        $bgMain    = [System.Drawing.Color]::FromArgb(22, 27, 34)     # #161B22
        $bgPanel   = [System.Drawing.Color]::FromArgb(33, 38, 45)     # #21262D
        $fgText    = [System.Drawing.Color]::FromArgb(230, 237, 243)   # #E6EDF3
        $bgBtn     = [System.Drawing.Color]::FromArgb(48, 54, 61)      # #30363D
        $fgBtn     = [System.Drawing.Color]::FromArgb(230, 237, 243)
        $borderBtn = [System.Drawing.Color]::FromArgb(72, 79, 88)      # #484F58
        $bgLog     = [System.Drawing.Color]::FromArgb(13, 17, 23)      # #0D1117
        $fgLog     = [System.Drawing.Color]::FromArgb(88, 166, 255)    # Biru moden
        $bgSidebar = [System.Drawing.Color]::FromArgb(13, 17, 23)     # #0D1117
        $bgInfoBox = [System.Drawing.Color]::FromArgb(13, 17, 23)
        $bgInput   = [System.Drawing.Color]::FromArgb(22, 27, 34)
        $fgInput   = [System.Drawing.Color]::FromArgb(230, 237, 243)
    } else {
        # -- LIGHT MODE --
        ...
        $borderBtn = [System.Drawing.Color]::FromArgb(200, 200, 200)
        $bgLog     = [System.Drawing.Color]::FromArgb(30, 30, 30)
        $fgLog     = [System.Drawing.Color]::LimeGreen
        $bgSidebar = [System.Drawing.Color]::FromArgb(15, 23, 42)
        $bgInfoBox = [System.Drawing.Color]::FromArgb(15, 23, 42)
        $bgInput   = [System.Drawing.Color]::White
        $fgInput   = [System.Drawing.Color]::Black
    }
    ...
    # Rekursif kemaskini semua panel dan kawalan (termasuk TextBox, ComboBox)
        ...
        if ($panel) {
            ...
            foreach ($ctrl in $panel.Controls) {
                if ($ctrl -is [System.Windows.Forms.Button]) {
                    $ctrl.BackColor = $bgBtn; $ctrl.ForeColor = $fgBtn
                    $ctrl.FlatStyle = 'Flat'
                    $ctrl.FlatAppearance.BorderColor = $borderBtn
                }
                elseif ($ctrl -is [System.Windows.Forms.Label]) { $ctrl.ForeColor = $fgText }
                elseif ($ctrl -is [System.Windows.Forms.TextBox]) { $ctrl.BackColor = $bgInput; $ctrl.ForeColor = $fgInput }
                elseif ($ctrl -is [System.Windows.Forms.ComboBox]) { $ctrl.BackColor = $bgInput; $ctrl.ForeColor = $fgInput }
                elseif ($ctrl -is [System.Windows.Forms.RichTextBox]) { $ctrl.BackColor = $bgInput; $ctrl.ForeColor = $fgInput }
                elseif ($ctrl -is [System.Windows.Forms.Panel]) {
                    $ctrl.BackColor = $bgPanel
                    foreach ($subCtrl in $ctrl.Controls) {
                        if ($subCtrl -is [System.Windows.Forms.Button]) {
                            $subCtrl.BackColor = $bgBtn; $subCtrl.ForeColor = $fgBtn
                            $subCtrl.FlatStyle = 'Flat'
                            $subCtrl.FlatAppearance.BorderColor = $borderBtn
                        }
                        elseif ($subCtrl -is [System.Windows.Forms.Label]) { $subCtrl.ForeColor = $fgText }
                        elseif ($subCtrl -is [System.Windows.Forms.TextBox]) { $subCtrl.BackColor = $bgInput; $subCtrl.ForeColor = $fgInput }
                        elseif ($subCtrl -is [System.Windows.Forms.ComboBox]) { $subCtrl.BackColor = $bgInput; $subCtrl.ForeColor = $fgInput }
                        elseif ($subCtrl -is [System.Windows.Forms.RichTextBox]) { $subCtrl.BackColor = $bgInput; $subCtrl.ForeColor = $fgInput }
                    }
                }
            }
        }
...
$panelLeft.BackColor = [System.Drawing.Color]::FromArgb(15, 23, 42)
...
$rtbInfo.BackColor = [System.Drawing.Color]::FromArgb(15, 23, 42)
...
$btnMenu6 = New-MainMenuButton "6. Tentang HBUK Suite" 330
$btnMenu6.Add_Click({
        # Dialog About — Premium (F-12)
        $aboutDlg = New-Object System.Windows.Forms.Form
        $aboutDlg.Text = "Tentang HBUK Suite"
        $aboutDlg.Size = New-Object System.Drawing.Size(520, 420)
        ...
        # Warna dinamik ikut tema semasa
        if ($script:IsDarkMode) {
            $abBg = [System.Drawing.Color]::FromArgb(13, 17, 23)
            $abAccent = [System.Drawing.Color]::FromArgb(88, 166, 255)
            $abText = [System.Drawing.Color]::FromArgb(200, 210, 230)
            $abSecond = [System.Drawing.Color]::FromArgb(139, 148, 158)
            $abBtnBg = [System.Drawing.Color]::FromArgb(48, 54, 61)
            $abBtnBdr = [System.Drawing.Color]::FromArgb(72, 79, 88)
        } else {
            $abBg = [System.Drawing.Color]::FromArgb(15, 23, 42)
            $abAccent = [System.Drawing.Color]::FromArgb(100, 200, 255)
            $abText = [System.Drawing.Color]::FromArgb(200, 210, 230)
            $abSecond = [System.Drawing.Color]::FromArgb(180, 190, 210)
            $abBtnBg = [System.Drawing.Color]::FromArgb(30, 40, 60)
            $abBtnBdr = [System.Drawing.Color]::FromArgb(80, 100, 140)
        }
        $aboutDlg.BackColor = $abBg
        ...
        $lblAboutTitle.Location = New-Object System.Drawing.Point(30, 20)
        ...
        $sep1.Location = New-Object System.Drawing.Point(30, 55)
        $sep1.Size = New-Object System.Drawing.Size(440, 2)
        $aboutDlg.Controls.Add($sep1)

        # Versi
        $lblVer = New-Object System.Windows.Forms.Label
        $lblVer.Text = "$([char]0x276E)/$([char]0x276F)  Versi: V4.5"
        $lblVer.Font = New-Object System.Drawing.Font("Segoe UI", 10)
        $lblVer.ForeColor = $abText
        $lblVer.Location = New-Object System.Drawing.Point(30, 70)
        $lblVer.AutoSize = $true
        $aboutDlg.Controls.Add($lblVer)

        # Tarikh bina (tarikh commit terakhir)
        $lblDate = New-Object System.Windows.Forms.Label
        $lblDate.Text = "$([char]0x1F4C5)  Tarikh Bina: 2026-05-10"
        $lblDate.Font = New-Object System.Drawing.Font("Segoe UI", 10)
        $lblDate.ForeColor = $abText
        $lblDate.Location = New-Object System.Drawing.Point(30, 100)
        $lblDate.AutoSize = $true
        $aboutDlg.Controls.Add($lblDate)

        # Separator
        $sep2 = New-Object System.Windows.Forms.Label
        $sep2.BorderStyle = 'Fixed3D'
        $sep2.Location = New-Object System.Drawing.Point(30, 135)
        $sep2.Size = New-Object System.Drawing.Size(440, 2)
        $aboutDlg.Controls.Add($sep2)

        # Organisasi
        $lblOrg = New-Object System.Windows.Forms.Label
        $lblOrg.Text = "$([char]0x25C9)  Unit Pengurusan Maklumat (UPM)"
        $lblOrg.Font = New-Object System.Drawing.Font("Segoe UI", 10, [System.Drawing.FontStyle]::Bold)
        $lblOrg.ForeColor = [System.Drawing.Color]::White
        $lblOrg.Location = New-Object System.Drawing.Point(30, 150)
        $lblOrg.AutoSize = $true
        $aboutDlg.Controls.Add($lblOrg)

        $lblHospital = New-Object System.Windows.Forms.Label
        $lblHospital.Text = "     Hospital Bahagia Ulu Kinta"
        $lblHospital.Font = New-Object System.Drawing.Font("Segoe UI", 10)
        $lblHospital.ForeColor = $abSecond
        $lblHospital.Location = New-Object System.Drawing.Point(30, 175)
        $lblHospital.AutoSize = $true
        $aboutDlg.Controls.Add($lblHospital)

        # Keterangan
        $lblDesc = New-Object System.Windows.Forms.Label
        $lblDesc.Text = "$([char]0x25A3)  Dibangunkan bagi memudahkan pengurusan`n     user deployment untuk Komputer HBUK."
        $lblDesc.Font = New-Object System.Drawing.Font("Segoe UI", 10)
        $lblDesc.ForeColor = $abSecond
        $lblDesc.Location = New-Object System.Drawing.Point(30, 210)
        $lblDesc.AutoSize = $true
        $aboutDlg.Controls.Add($lblDesc)

        # GitHub link
        $lblGH = New-Object System.Windows.Forms.LinkLabel
        $lblGH.Text = "$([char]0x2794)  github.com/C4P1K"
        $lblGH.Font = New-Object System.Drawing.Font("Segoe UI", 9)
        $lblGH.LinkColor = $abAccent
        $lblGH.ActiveLinkColor = [System.Drawing.Color]::White
        $lblGH.Location = New-Object System.Drawing.Point(30, 260)
        $lblGH.AutoSize = $true
        $lblGH.Add_LinkClicked({ Start-Process "https://github.com/C4P1K" })
        $aboutDlg.Controls.Add($lblGH)

        # Signature — by CAPIK
        $lblBy = New-Object System.Windows.Forms.Label
        $lblBy.Text = "by CAPIK"
        $lblBy.Font = New-Object System.Drawing.Font("Segoe UI", 11, [System.Drawing.FontStyle]::Italic)
        $lblBy.ForeColor = $abAccent
        $lblBy.Location = New-Object System.Drawing.Point(370, 285)
        $lblBy.AutoSize = $true
        $aboutDlg.Controls.Add($lblBy)

        # Butang Tutup
        $btnAboutOk = New-Object System.Windows.Forms.Button
        $btnAboutOk.Text = "$([char]0x23FB)  Tutup"
        $btnAboutOk.Location = New-Object System.Drawing.Point(170, 325)
        $btnAboutOk.Size = New-Object System.Drawing.Size(160, 35)
        $btnAboutOk.FlatStyle = "Flat"
        $btnAboutOk.ForeColor = [System.Drawing.Color]::White
        $btnAboutOk.BackColor = $abBtnBg
        $btnAboutOk.Font = New-Object System.Drawing.Font("Segoe UI", 10)
        $btnAboutOk.FlatAppearance.BorderColor = $abBtnBdr
...
# Tiada fallback — fail config MESTI wujud
function Install-SPAIWithTag($finalTag) {
    ...
    if (Test-Path $spaiCfg) {
        ...
        Write-Log "RALAT: spai_config.txt tidak dijumpai."
        [System.Windows.Forms.MessageBox]::Show("Fail 'packages\config\spai_config.txt' tidak dijumpai.`nSila salin dari spai_config.example.txt dan isi URL server.", "Ralat Config", 0, 48)
        return
    }
    if (-not $serverUrl) {
        Write-Log "RALAT: SERVER URL kosong dalam spai_config.txt."
        [System.Windows.Forms.MessageBox]::Show("SERVER URL kosong dalam spai_config.txt.`nSila isi URL server SPAI.", "Ralat Config", 0, 48)
        return
    }
...
$cmbL1 = New-LabeledComboBox "1. Bahagian" 45
