...
namespace HBUKLauncher
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            string ps1Path = Path.Combine(appDir, "HBUK_USER_DEPLOYMENT_SUITE_V4.4.ps1");
            
            if (!File.Exists(ps1Path)) {
                System.Windows.Forms.MessageBox.Show("Fail 'HBUK_USER_DEPLOYMENT_SUITE_V4.4.ps1' tidak dijumpai di dalam folder ini.", "Ralat", System.Windows.Forms.MessageBoxButtons.OK, System.Windows.Forms.MessageBoxIcon.Error);
                return;
            }
